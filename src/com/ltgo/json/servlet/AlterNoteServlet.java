...
/**
 * Servlet implementation class AlterNoteServlet
 */
@WebServlet("/AlterNoteServlet")
public class AlterNoteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AlterNoteServlet() {
        super();
...
response.setContentType("application/json;charset=utf-8");
		...
		List<ReviseNote> rn_list=njdi.alterNoteRequest(id);
		String newJson=g.toJson(rn_list);
